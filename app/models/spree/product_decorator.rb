Spree::Product.class_eval do
  ...
  def all_active_relatables
    ids = has_variants? ? variant_ids : variants_including_master_ids
  ...
  def all_active_copayments
    ids = Spree::CopaymentRelation.active.where(relatable_id: all_active_relatables.ids).pluck(:related_to_id)
